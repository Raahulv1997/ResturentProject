      ...
      <Box sx={{m:3, width:"600px", ml:10,"@media (max-width:600px)":{width:"300px"}}}>
        <TableContainer component={Paper}>
          ...
          <TableBody>
            <TableRow>
              <TableCell>
                <SupportAgentIcon sx={{color:"red", pt:1}}/>1800-00-23556(toll free)
              </TableCell>
            </TableRow>

            <TableRow>
              <TableCell>
                <MailIcon sx={{color:"green", pt:1}}/>Myresturent@help.com
              </TableCell>
            </TableRow>
            
            <TableRow>
              <TableCell>
                <CallIcon sx={{color:"skyblue", pt:1}}/>+91 8269364180
              </TableCell>
            </TableRow>
          </TableBody>
          </Table>
